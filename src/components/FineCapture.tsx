                ...
                <span key={rule.id}>
                  <button
                    ...
                    className={[
                      ...
                      'inline-flex min-h-12 items-center rounded-btn border px-3 text-left text-[0.7rem]',
                      active
                  ...
                  {minutesFor === key && (
                    <label className="mt-1 flex items-center gap-2 text-[0.7rem] text-muted">
                      ...
                      <input
                        ...
                        className="tabular min-h-12 w-20 rounded-btn border border-line bg-raised px-2 text-ink"
                        onKeyDown={(e) => {
                          if (e.key === 'Escape') {
                            setMinutesFor(null)
                            setRefusedFor(null)
